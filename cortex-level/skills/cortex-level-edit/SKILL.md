...
3. BATCH: call `level_batch` once with the full spec.
...
TOOL SELECTION RULE:
- level_batch: 2+ spawns OR 3+ existing actor modifications OR any spawn+configure chain
