...
| Animation | Skeletal animation inspection; guarded named/object notifies, notify states, float curves, montage sections, and skeleton sockets | `/cortex-animation` |
